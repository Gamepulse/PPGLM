  ...
  return (
    <div className="relative max-w-4xl mx-auto p-6 min-h-screen">
      ...
      <div className="pt-4 theme-border border-t mt-6 space-y-4">
        ...
        <div>
          <label htmlFor="executable-path-input" className="block text-sm font-medium theme-text-secondary mb-1">{t('executablePath')}</label>
          <div className="flex gap-2">
            <input
              id="executable-path-input"
              type="text"
        ...
        {/* Completion Status */}
        <div>
          <label htmlFor="completion-status-select" className="block text-sm font-medium theme-text-secondary mb-1">{t('completionStatus')}</label>
          <select
        ...
        {/* Play Time */}
        <div>
          <label htmlFor="play-time-input" className="block text-sm font-medium theme-text-secondary mb-1">{t('playTime')} ({t('hours')})</label>
          <input
            id="play-time-input"
            type="number"
            min="0"
        ...
        <div>
          <label htmlFor="notes-textarea" className="block text-sm font-medium theme-text-secondary mb-1">{t('notes')}</label>
          <textarea
            id="notes-textarea"
