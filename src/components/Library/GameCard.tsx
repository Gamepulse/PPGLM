      ...
      <div className="flex flex-wrap gap-1 mt-1">
        {allMetadata.map((item) => (
          <button
            ...
            className="px-1.5 py-0.5 text-xs rounded bg-gray-700/50 theme-text-muted hover:bg-indigo-600/30 transition-colors cursor-pointer select-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-indigo-500"
  ...
  const renderStatusBadge = () => {
    ...
    return (
      <button
        ...
        className={`absolute top-2 left-2 z-10 px-2 py-1 rounded-full text-xs text-white ${statusColors[completion_status] || 'bg-gray-600'} hover:opacity-80 transition-opacity cursor-pointer select-none focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-white/50`}
          ...
          <h3 className="theme-text-primary font-semibold text-lg mb-2 truncate flex items-center gap-2">
            ...
            {showQuickAssign && (
              <button
                ...
                className="ml-auto text-xs px-2 py-1 bg-orange-500 hover:bg-orange-600 text-white rounded transition-colors focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-orange-500"
                title={t('selectPlatform') || "Quick assign platform"}
                aria-label={t('selectPlatform') || "Quick assign platform"}
              >
                🎮
              </button>
            )}
        ...
        <div className="relative h-24 bg-gray-800">
          ...
          {completion_status && completion_status !== 'not_started' && (
            <button
              ...
              } hover:opacity-80 transition-opacity cursor-pointer focus-visible:ring-1 focus-visible:ring-white/50`}
          ...
          {showQuickAssign && (
            <button
              ...
              className="absolute bottom-1 left-1 w-5 h-5 flex items-center justify-center text-[10px] bg-orange-500 hover:bg-orange-600 text-white rounded transition-colors z-10 focus-visible:ring-1 focus-visible:ring-orange-500"
              title={t('selectPlatform') || "Quick assign platform"}
              aria-label={t('selectPlatform') || "Quick assign platform"}
            >
              🎮
          ...
          <h3 className="theme-text-primary font-semibold text-lg mb-2 flex items-center gap-2">
            ...
            {showQuickAssign && (
              <button
                ...
                className="ml-2 text-xs px-2 py-1 bg-orange-500 hover:bg-orange-600 text-white rounded transition-colors focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-orange-500"
                title={t('selectPlatform') || "Quick assign platform"}
                aria-label={t('selectPlatform') || "Quick assign platform"}
              >
                🎮
