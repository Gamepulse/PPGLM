  ...
  return (
    <div className="flex gap-6">
      <div className="w-64 flex-shrink-0 space-y-3">
        ...
        {onPlatformChange && (
          <div>
            <label htmlFor="platform-selector" className="block text-xs font-medium theme-text-secondary mb-1">
      ...
      <div className="flex-1 space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label htmlFor="personal-rating-range" className="theme-text-muted text-sm">{t('personalRating')} (0-100): <span className="text-purple-500 font-semibold">{game.personal_rating !== null && game.personal_rating !== undefined ? `${game.personal_rating}/100` : '-'}</span></label>
          </div>
          <div className="flex items-center gap-3">
            <span className="text-xs theme-text-muted" aria-hidden="true">0</span>
            <input
              id="personal-rating-range"
              type="range"
              min="0"
              max="100"
              step="1"
